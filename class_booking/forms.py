...
class BookingForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        available_options = {
            'Mat Pilates for Stabilization': ['Monday 16:30', 'Wednesday 16:30', 'Friday 14:00'],
        ...
        # Check if the selected day and time are in the allowed slots: day, hour, minute
        if selected_datetime.strftime('%A %H:%M') not in available_options[booked_class.class_name]:
            ...
            raise ValidationError(f"Invalid class date/time for {booked_class.class_name}")
